...
class PMBOKServiceRBAC {
  ...
  constructor() {
    ...
    console.log('ðŸ”§ PMBOK Service RBAC: Created with default demo context')
  }
  ...
  async initialize(userId?: string, tenantId?: string) {
    if (userId && tenantId) {
      ...
      console.log('âœ… PMBOK Service RBAC: Initialized with user context:', { userId, tenantId })
    } else {
      console.log('âš ï¸ PMBOK Service RBAC: Using demo context - no user/tenant provided')
    }
  }
  ...
  updateUserContext(userId: string, tenantId: string) {
    if (this.currentUserId !== userId || this.currentTenantId !== tenantId) {
      console.log('ðŸ”„ PMBOK Service RBAC: Updating user context:', { 
    ...
    return withPermissionCheck(
      ...
      async () => {
        try {
          ...
          if (error) {
            console.error('âŒ Error fetching work requests:', error)
            return []
          }

          console.log('âœ… Work requests loaded successfully:', workRequests?.length || 0)
          return await this.handleMissingCustomers(workRequests || [])

        } catch (error) {
          console.error('âŒ Exception in getWorkRequests:', error)
          return []
        }
      }
    )
  ...
  async createWorkRequest(workRequest: Partial<WorkRequestWithApproval>): Promise<WorkRequestWithApproval | null> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ“ Creating new work request:', workRequest.title)
          ...
          if (error) {
            console.error('âŒ Error creating work request:', error)
            return null
          }

          console.log('âœ… Work request created successfully:', data.id)
          return data

        } catch (error) {
          console.error('âŒ Exception in createWorkRequest:', error)
          return null
        }
      }
    )
  ...
  async updateWorkRequest(id: string, updates: Partial<WorkRequestWithApproval>): Promise<WorkRequestWithApproval | null> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ“ Updating work request:', id)
          ...
          if (error) {
            console.error('âŒ Error updating work request:', error)
            return null
          }

          console.log('âœ… Work request updated successfully:', id)
          return data

        } catch (error) {
          console.error('âŒ Exception in updateWorkRequest:', error)
          return null
        }
      }
    )
  ...
  async approveWorkRequest(id: string, approvedBy: string): Promise<boolean> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('âœ… Approving work request:', id)
          ...
          console.log('âœ… Work request approved successfully:', id)
          return true

        } catch (error) {
          console.error('âŒ Exception in approveWorkRequest:', error)
          return false
        }
      }
    )
  ...
  async declineWorkRequest(id: string, reason: string, reviewedBy: string): Promise<boolean> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('âŒ Declining work request:', id)
          ...
          console.log('âœ… Work request declined successfully:', id)
          return true

        } catch (error) {
          console.error('âŒ Exception in declineWorkRequest:', error)
          return false
        }
      }
    )
  ...
  async getProjects(): Promise<ProjectCharter[]> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ” loading project charters from database...')
          ...
          console.log('âœ… Project charters loaded successfully:', projects?.length || 0)
          return projects || []

        } catch (error) {
          console.error('âŒ Exception in getProjects:', error)
          return []
        }
      }
    )
  ...
  async createProjectCharter(charter: Partial<ProjectCharter>): Promise<ProjectCharter | null> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ“ Creating new project charter:', charter.title)
          ...
          console.log('âœ… Project charter created successfully:', data.id)
          return data

        } catch (error) {
          console.error('âŒ Exception in createProjectCharter:', error)
          return null
        }
      }
    )
  ...
  async getRisks(): Promise<Risk[]> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ” loading risks from database...')
          ...
          console.log('âœ… Risks loaded successfully:', risks?.length || 0)
          return risks || []

        } catch (error) {
          console.error('âŒ Exception in getRisks:', error)
          return []
        }
      }
    )
  ...
  async createRisk(risk: Partial<Risk>): Promise<Risk | null> {
    return withPermissionCheck(
      ...
      async () => {
        try {
          console.log('ðŸ“ Creating new risk:', risk.title)
          ...
          if (error) {
            console.error('âŒ Error creating risk:', error)
            return null
          }

          console.log('âœ… Risk created successfully:', data.id)
          return data

        } catch (error) {
          console.error('âŒ Exception in createRisk:', error)
          return null
        }
      }
    )
    ...
    return withPermissionCheck(
      ...
      async () => {
        try {
          ...
          console.log('âœ… Users loaded successfully:', users?.length || 0)
          return users || []

        } catch (error) {
          console.error('âŒ Exception in getUsers:', error)
          return []
        }
      }
    )
    ...
    return withPermissionCheck(
      ...
      async () => {
        try {
          ...
          console.error('âŒ Exception in getDashboardData:', error)
          return {
  ...
  private async handleMissingCustomers(workRequests: any[]): Promise<WorkRequestWithApproval[]> {
    ...
    if (customerIds.length === 0) {
      console.log('âš ï¸ No customer IDs found in work requests')
    ...
    try {
      console.log('ðŸ‘¥ Fetching customer information for IDs:', customerIds)
      ...
      if (error) {
        console.error('âŒ Error fetching customer profiles:', error)
        return workRequests.map((wr: any) => ({
          ...wr,
          customer_name: 'Unknown Customer'
        }))
      ...
      console.error('âŒ Exception during customer lookup:', error)
      return workRequests.map((wr: any) => ({
        ...wr,
        customer_name: 'Unknown Customer'
      }))
