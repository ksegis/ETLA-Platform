    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          unconfirmedUsers,
          expiredInvites,
          totalToDelete: inactiveUsers + unconfirmedUsers + expiredInvites
        }
      }
    } catch (error: any) {
  ...
  executeUserCleanup: async (options: CleanupOptions) => {
    try {
      ...
      if (options.deleteExpiredInvites) {
        ...
        deletedExpiredInvites = expiredInvites?.length || 0
      }
      ...
      return {
        ...
        data: {
          deletedInactiveUsers,
          deletedUnconfirmedUsers,
          deletedExpiredInvites,
          totalDeleted: deletedInactiveUsers + deletedUnconfirmedUsers + deletedExpiredInvites
        }
      }
    } catch (error: any) {
