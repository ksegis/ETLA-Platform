...
const EnhancedReportingPage: React.FC = () => {
  ...
  const loadTabData = useCallback(async (tabId: string) => {
    ...
    } else if (isMultiTenant && accessibleTenantIds && accessibleTenantIds.length > 0) {
  ...
  }, [tenantloading, isDemoMode, isMultiTenant, tenantFilter, selectedTenant, accessibleTenantIds]);
