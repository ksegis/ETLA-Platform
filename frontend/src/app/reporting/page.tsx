            ...
            <Card className="bg-white shadow-lg">
              ...
              <CardContent className="p-4">
                <div className="text-center text-gray-500">
                  <p>Enhanced employee demographics</p>
                  <p className="text-sm">will be loaded here</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Tabs value={activeDataTab} onValueChange={setActiveDataTab} className="w-full">
              <TabsContent value="pay-statements" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Pay statement data for ${selectedEmployee.full_name} will be loaded here` 
              ...
              <TabsContent value="timecards" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Timecard data for ${selectedEmployee.full_name} will be loaded here` 
              ...
              <TabsContent value="tax-records" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Tax record data for ${selectedEmployee.full_name} will be loaded here` 
              ...
              <TabsContent value="benefits" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Benefits data for ${selectedEmployee.full_name} will be loaded here` 
              ...
              <TabsContent value="job-history" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Job history data for ${selectedEmployee.full_name} will be loaded here` 
              ...
              <TabsContent value="documents" className="mt-0">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    {selectedEmployee 
                      ? `Document data for ${selectedEmployee.full_name} will be loaded here` 
