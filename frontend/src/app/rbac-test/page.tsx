    ...
    return (
      <DashboardLayout>
        <div className="p-6 space-y-6">
          ...
          <p className="text-gray-600">Loading authentication and permissions...</p>
        </div>
      </DashboardLayout>
    )
  }
      ...
      <div className="p-6 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <p><strong>Current User ID:</strong> {user?.id || 'N/A'}</p>
            <p><strong>Current User Email:</strong> {user?.email || 'N/A'}</p>
            <p><strong>Current Tenant User Role:</strong> {tenantUser?.role || 'N/A'}</p>
            <p><strong>Current User Role (from usePermissions):</strong> {currentUserRole || 'N/A'}</p>
          </CardContent>
        </Card>
