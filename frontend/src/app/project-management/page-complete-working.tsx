    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{projectMetrics.compliance}%</p>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            PMBOK 7th Edition compliant project charters
          </CardDescription>
        </CardHeader>
        <CardContent>
          {dashboardData.loading ? (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredProjectCharters.map((charter: any) => (
                    <tr key={charter.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {charter.estimated_budget ? formatCurrency(charter.estimated_budget) : 'TBD'}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {charter.planned_start_date ? new Date(charter.planned_start_date).toLocaleDateString() : 'TBD'}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          <Button
                    ...
                    <tr key={risk.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          risk.risk_level === 'critical' ? 'text-red-600 bg-red-50' :
                          risk.risk_level === 'high' ? 'text-orange-600 bg-orange-50' :
                          risk.risk_level === 'medium' ? 'text-yellow-600 bg-yellow-50' :
