...
export default function ProjectManagementPage() {
  ...
  const renderWorkRequestsTab = () => (
    <div className="space-y-6">
      ...
      {/* Filters and Search - ENHANCED with approval statuses */}
      ...
      {/* Work Requests Table - ENHANCED with approval actions */}
      <Card>
        <CardHeader>
                    ...
                    <tr key={request.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          {/* NEW: Approval button for eligible requests */}
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            PMBOK-compliant project charters and documentation
          </CardDescription>
        </CardHeader>
        <CardContent>
          {dashboardData.loading ? (
                  ...
                  {filteredProjectCharters.map((charter: any) => (
                    <tr key={charter.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {charter.project_sponsor}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {charter.project_manager}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {formatCurrency(charter.estimated_budget || 0)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(charter.charter_status || 'unknown')}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center space-x-2">
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => handleViewCharter(charter.id)}
                          >
                            <Eye className="h-4 w-4" />
                          </Button>
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => handleEditCharter(charter.id)}
                          >
                            <Edit className="h-4 w-4" />
                          </Button>
                        </div>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            PMBOK-compliant risk identification and management
          </CardDescription>
        </CardHeader>
        <CardContent>
          {dashboardData.loading ? (
