...
import { pmbok } from '@/services/pmbok_service_auth_stable'
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">
              User: {auth.user?.email} | Tenant: {auth.tenant?.name}
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {dashboardData.risks.filter((r: any: any) => r.risk_score && r.risk_score >= 15).length}
              </div>
              <p className="text-xs text-muted-foreground">
        ...
        {showMissingCustomerModal && missingCustomerRequests.length > 0 && (
          <MissingCustomerModal
            workRequestId={missingCustomerRequests[0].id}
            workRequestTitle={missingCustomerRequests[0].title}
